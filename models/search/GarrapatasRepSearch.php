 ...
 */
class GarrapatasRepSearch extends Garrapatas
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['p03_domicilio', 'r01_municipio', 'r01_estado', 'p03_fec_ult_trata', 'p03_destino', 'p03_municipio', 'p03_estado', 'p03_ruta1', 'p03_ruta2', 'p03_ruta3', 'p03_transporte', 'p03_marca', 'p03_placas', 'p03_flejado', 'p03_fec_exp', 'p03_lugar_exp', 'p03_fec_venc', 'p03_exp_nombre', 'p03_exp_rfc', 'p03_exp_cargo', 'p03_avalado_nombre', 'p03_observaciones','fecha_desde','fecha_hasta','p03_folio','repetidos_gr'], 'safe'],
        ];
    }
    ...
    {
        $query = Garrapatas::find()->select('*, COUNT(*) AS repetidos_gr')
            ->groupBy(['p03_fec_exp', 'r01_id', 'c07_id'])
            ->having('repetidos_gr>1')
            ->orderby(['repetidos_gr'=>SORT_DESC]);
        ...
        $query->andFilterWhere(['like', 'p03_cant_ov', $this->repetidos_gr]);
